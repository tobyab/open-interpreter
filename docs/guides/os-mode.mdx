...
To run OS mode on any local model, use the `--profile local-os` flag:

```bash
interpreter --profile local-os
```

This will configure OS mode to work with any local model you have set up.
